...
public class BookMain extends JFrame implements ActionListener{
	...
	private void createListen(String title, int w, int h, String str){
		if(str.equals("dae")){
			childWinDae = new JInternalFrame(title, false, true, false, true);
			childWinDae.setSize(w, h);
		}else if(str.equals("ban")){
			childWinBan = new JInternalFrame(title, false, true, false, true);
			childWinBan.setSize(w, h);
		}else if(str.equals("customer")){
			childWinCustomer = new JInternalFrame(title, false, true, false, true);
			childWinCustomer.setSize(w, h);
		}else if(str.equals("book")){
			childWinBook = new JInternalFrame(title, false, true, false, true);
			childWinBook.setSize(w, h);
		}else if(str.equals("etc")){
			childWinEtc = new JInternalFrame(title, false, true, false, true);
